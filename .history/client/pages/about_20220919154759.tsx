...
const AboutPage = () => (
  <Layout title="About DEV - DEV Community 👩‍💻👨‍💻">
    <div className="px-10 mx-auto w-[85vw] max-w-[1000px] bg-white rounded pt-10 pb-20 text-xl">
      ...
      <a href='https://res.cloudinary.com/practicaldev/image/fetch/s--kztNb6c8--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://dev-to-uploads.s3.amazonaws.com/uploads/articles/8pdz0airtdl81h1ykhx1.jpg'>
