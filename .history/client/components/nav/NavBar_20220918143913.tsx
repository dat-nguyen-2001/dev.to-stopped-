    ...
    return (
        <div className="flex nav-wrapper w-screen h-[60px] px-2">
            <div className="flex space-x-3 h-[70%] my-auto md:space-x-0">
                ...
                <div className="md:right-32 lg:relative lg:right-2 w-[250px] right-[15vw] bg-black/50 flex items-center h-[35px] border-white border-[1.5px]">
                    <SearchIcon className="cursor-pointer w-5 lg:w-6 left-1 absolute" />
                    <input
                        placeholder="Search ..."
