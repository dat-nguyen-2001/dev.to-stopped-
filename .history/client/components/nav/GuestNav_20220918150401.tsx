...
const GuestNav = () => {
    return (
        <div className='flex space-x-1'>
            ...
            <Link href={"/enter"}>
                <button className='w-full h-[40px] border-solid border-[#3e51e0] border-2 px-2 rounded-md text-[#3e51e0] hover:bg-[#3e51e0]/25 hover:text-[#3e51e0]/80 hover:underline'>
                    Login
                </button>
            </Link>
            <Link href={"/register"}>
