...
const NavBar = () => {
    return (
        <div className="flex nav-wrapper w-screen h-[60px] px-2">
            <div className="flex items-center space-x-01 h-[70%] my-auto md:space-x-0">
                ...
                <div className=" ml-[10px] w-[400px] flex items-center text-center h-[40px] border-[1.5px] rounded">
                    <input
                        placeholder="Search..."
