...
const NavBar = () => {
    return (
        <div className="flex nav-wrapper w-screen h-[60px] px-2 lg:px-36">
            <div className="flex items-center space-x-3 h-[70%] w-full my-auto md:space-x-reverse md:space-x-5">
                ...
                <div className="hidden w-[400px] md:flex items-center text-center h-[40px] border-[1.5px] rounded">
                    <input
                        placeholder="Search..."
